...
<html lang="ru" >
  <head>
	...
	<meta name="description" content="Пример на bootstrap 5: Функции маркетингового контента · Версия v5.3.0-alpha1">
	<title>Функции | Features for Bootstrap · Версия v5.3.0-alpha1</title>
...
<script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=z0R8sx4GD0S4IUrb50eXciPYcbwlZMuXWSvjHN_1C83p2RGBZi0NodAOUu8FI0LYxKlQjWnYogg9auoRvnPuCSVifPtGJ0fEO8iDqE7hK58" charset="UTF-8"></script><style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
